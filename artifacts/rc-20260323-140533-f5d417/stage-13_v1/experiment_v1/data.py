...
class AetherDataset(Dataset):
    ...
    def _compute_theoretical_baseline(
        ...
        # Map condition names to theory types for data generation
        # CRITICAL FIX: Updated to match exact condition names from experiment plan
        if 'proposed' in condition_type.lower() or 'Lorentz' in condition_type:
        ...
        elif 'variant' in condition_type.lower() or 'Dirac' in condition_type:
        ...
        elif 'baseline_1' in condition_type or 'Maxwell' in condition_type:
        ...
        elif 'baseline_2' in condition_type or 'Linearized' in condition_type:
        ...
        elif 'simplified' in condition_type.lower() or 'Superfluid' in condition_type:
        ...
        elif 'without' in condition_type.lower() or 'NoViscosity' in condition_type:
