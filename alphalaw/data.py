...
SP_BONDS = [
    ...
    # --- Period 4-5 heteronuclear (new, 2026-04-12) ---
    _b("Ge-Se", "s/p", 4, "Ge", "Se", 4, 6, 0, 2, {1:298, 2:430},           "CRC"),
    _b("Ge-S",  "s/p", 4, "Ge", "S",  4, 6, 0, 2, {1:371, 2:534},           "CRC"),
    _b("As-O",  "s/p", 4, "As", "O",  5, 6, 1, 2, {1:301, 2:481},           "CRC"),
    _b("As-S",  "s/p", 4, "As", "S",  5, 6, 1, 2, {1:260, 2:380},           "CRC"),
    _b("Se-O",  "s/p", 4, "Se", "O",  6, 6, 2, 2, {1:285, 2:470},           "CRC; NIST"),
    _b("Sn-O",  "s/p", 5, "Sn", "O",  4, 6, 0, 2, {1:531, 2:575},           "CRC"),
    _b("Sn-S",  "s/p", 5, "Sn", "S",  4, 6, 0, 2, {1:464, 2:510},           "CRC; NIST"),
    _b("Sb-Sb", "s/p", 5, "Sb", "Sb", 5, 5, 1, 1, {1:121, 2:310},           "CRC; Balasubramanian"),
    _b("Pb-O",  "s/p", 6, "Pb", "O",  4, 6, 0, 2, {1:382, 2:416},           "CRC"),
    _b("Bi-Bi", "s/p", 6, "Bi", "Bi", 5, 5, 1, 1, {1:105, 2:280},           "CRC; Balasubramanian"),
]
